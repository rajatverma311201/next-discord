                        ...
                        <FormItem>
                            <FormControl>
                                <div className="relative p-4 pb-6">
                                    ...
                                    <Input
                                        disabled={isLoading}
                                        className="rounded-md border-0 border-none bg-zinc-200/90 px-14 py-6 text-zinc-600 focus-visible:ring-0 focus-visible:ring-offset-0 dark:bg-zinc-700/75 dark:text-zinc-200"
                                        placeholder={`Message ${
                                            type === "conversation"
                                                ? name
                                                : "#" + name
